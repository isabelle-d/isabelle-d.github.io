import {  Fieldset,  Tab, Tabs,  Frame, Video } from '@react95/core';
    ...
    return(
        <Tabs defaultActiveTab="Personal">
            <Tab title = "Game Assets">
                ...
                <img src = "assets/art/healthbar.png" style = {{height: "auto", width: "80%"}}></img>
                <Video src = "assets/art/ability.mp4" style = {{height: "auto", width: "80%"}}></Video>
            ...
            <Tab title = "Personal">
            <Frame >
                <div title = "Personal" style={{ display: "grid", gridTemplateColumns: "1fr 1fr",gap: "10px"}}>
